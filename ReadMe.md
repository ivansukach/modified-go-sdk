...
Add "github.com/ivansukach/modified-go-sdk" dependency into your go.mod file. Example:
```go
require (
	github.com/ivansukach/modified-go-sdk latest
)
...
```GO
import sdk "github.com/ivansukach/modified-go-sdk/client"
...
For more API usage documentation, please check the [wiki](https://github.com/ivansukach/modified-go-sdk/wiki)..
